...
class TestRoutingAndNAT:
    ...
    @allure.description(
        "Sends 4 ICMP echo requests from Site A's LAN IP (10.1.0.1) to Site B's LAN IP "
        "(10.2.0.1) through the VPN tunnel. Source is pinned to 10.1.0.1 via -I to "
    ...
    @allure.description(
        ...
        "(10.2.0.1) to Site A's LAN IP (10.1.0.1). A one-directional pass is insufficient "
